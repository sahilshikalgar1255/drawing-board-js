...
// For those with a background image, first draw the background image, and then cover it with handwriting. Otherwise, the data generated is only handwriting, and the data generated by toDataURL does not include the background image.
...
export function detectLanguage() {
  return navigator.language.indexOf('zh') !== -1 ? 'Please click to enter' : 'Type here...'
}